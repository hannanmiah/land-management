<div class="container px-6 mx-auto grid">
    ...
    <div class="my-6 flex justify-between items-center">
        ...
        <section class="print:hidden inline-flex space-x-2">
            <a
                href="{{route('invoices.plot',['page' => $plots->currentPage()])}}"
            ...
            <table class="w-full whitespace-no-wrap print:border">
                ...
                @forelse($plots as $plot)
                    <tr class="text-gray-700 dark:text-gray-400">
                        ...
                        <td class="px-4 py-3 text-sm">
                            @if($plot->document)
                                {{$plot->document->no}} ({{$plot->document->owner}})
                            @else
                        ...
                        <td class="px-4 py-3 print:hidden">
                            <div class="flex items-center space-x-4 text-sm">
                                <a
                                    href="{{route('plots.edit',['plot' => $plot->id])}}"
