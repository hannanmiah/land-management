    ...
    <form wire:submit.prevent="submit" class="flex flex-col space-y-2 md:space-y-4" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <select
                ...
                id="document"
                wire:model="document"
                class="disabled:opacity-25 block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-select focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray"
            >
