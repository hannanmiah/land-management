<div class="container px-6 mx-auto grid">
    ...
    <div class="my-6 flex justify-between items-center">
        ...
        <section class="print:hidden inline-flex space-x-2">
            <a
                href="{{route('invoices.sold',['page' => $solds->currentPage()])}}"
        ...
        <div class="w-full overflow-x-auto">
            <table class="w-full whitespace-no-wrap print:border">
                ...
                >
                    ...
                    <th class="px-4 py-3">Statement No.</th>
                    ...
                    <tr class="text-gray-700 dark:text-gray-400">
                        ...
                        <td class="px-4 py-3 print:hidden">
                            <div class="flex items-center space-x-1 text-sm">
                                <a
                                    href="{{route('soldlands.show',['sold' => $sold->id])}}"
                                ...
                                <a
                                    href="{{route('soldlands.edit',['sold' => $sold->id])}}"
                                    class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-purple-600 rounded-lg dark:text-gray-400 focus:outline-none focus:shadow-outline-gray"
                                    aria-label="Edit"
                                >
                                    <svg
